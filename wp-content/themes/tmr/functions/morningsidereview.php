...
function tuts_mcekit_editor_style($url) {
    ...
    $url .= get_stylesheet_directory_uri(). '/css/custom-styles.css';
...
function tuts_mcekit_editor_enqueue() {
  $StyleUrl = get_stylesheet_directory_uri(). '/css/custom-styles.css'; // Customstyle.css is relative to the current file
